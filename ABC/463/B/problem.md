...
出典: https://atcoder.jp/contests/abc463/tasks/abc463_b
...
高橋君が予約する候補としている列車は $N$ 本あり、列車 $1,2,\dots,N$ と番号が付けられています。
いずれの列車も座席は $5$ 列からなり、それぞれ A 列、B 列、C 列、D 列、E 列と呼ばれています。
